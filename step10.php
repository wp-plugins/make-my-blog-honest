...
// Step 10 - Using Ajax from viewer facing pages
...
/* MODIFIED CODE */
			...
			/* Register the popup script that is going to pull a 
				random deal from the table */
			wp_register_script(
				'eds_annoying_popup',
			...
			/* Pass the prefix to the JS so it can namespace the 
				action variable, and pass an nonce to the JS so it can perform
				a valid action call */
			wp_localize_script(
				'eds_annoying_popup',
...
/* NEW CODE */
			...
			/* If GetRandomDeal has been called, then lets grab 
				our deal-display HTML and return it */
...
/* NEW CODE */
		...
		private function GetRandomDeal()
		{
			...
			/* Get a random deal from the database */
...
/* We've now added AJAX to our viewer facing pages that degrades gracefully. Holy Mackerel! */
